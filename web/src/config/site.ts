 ...
 * Placeholder until the real domain is decided — sitemap, canonical links,
 * and OG URLs all derive from this constant (robots.txt must be updated by hand).
 */
export const SITE_URL = 'https://darkmodelite.example.com';
